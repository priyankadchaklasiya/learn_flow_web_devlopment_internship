...
try {
    ...
    // Prepare SQL query to fetch courses based on search text
    $stmt = $conn->prepare("SELECT c.*, COALESCE(e.number_of_students, 0) AS number_of_students
                                    ...
                                    WHERE c.title LIKE '%" . $searchText . "%' OR cat.name LIKE '%" . $searchText . "%';");
    ...
    // Display error message in case of database connection issues
    ...
    <div class="row py-2 px-lg-5">
        ...
        <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
            ...
            <div class="d-inline-flex align-items-center text-white">
                ...
                <small><i class="fa fa-envelope mr-2"></i>contact@StudyFlow.com</small>
            </div>
        </div>
        ...
        <div class="col-lg-6 text-center text-lg-right">
            ...
            <div class="d-inline-flex align-items-center">
                ...
                <a class="text-white px-2" href="https://www.facebook.com/StudyFlows/">
                    <i class="fab fa-facebook-f"></i>
                </a>

                <!-- Anchor tag with Twitter icon and link -->
                <a class="text-white px-2" href="https://twitter.com/StudyFlows">
                    <i class="fab fa-twitter"></i>
                </a>

                <!-- Anchor tag with LinkedIn icon and link -->
                <a class="text-white px-2" href="https://www.linkedin.com/in/StudyFlows/">
                    <i class="fab fa-linkedin-in"></i>
                </a>

                <!-- Anchor tag with Instagram icon and link -->
                <a class="text-white px-2" href="https://www.instagram.com/StudyFlows">
                    <i class="fab fa-instagram"></i>
                </a>

                <!-- Anchor tag with YouTube icon and link -->
                <a class="text-white pl-2" href="https://youtube.com/StudyFlows">
...
<div class="container-fluid p-0">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
        ...
        <a href="index.php" class="navbar-brand ml-lg-3">
            <!-- Heading with StudyFlow title and book icon -->
            <h1 class="m-0 text-uppercase text-primary"><i class="fa fa-book-reader mr-3"></i>StudyFlow</h1>
        </a>
...
<div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
    ...
    <div class="container text-center py-5">
        ...
        <h1 class="text-white display-1 mb-5">Course Search</h1>
        ...
        <div class="d-inline-flex text-white mb-5" style="font-size: 25px">
            <p class="m-0 text-uppercase"><a class="text-white" >Search</a></p>
            <i class="fa fa-angle-double-right pt-1 px-3"></i>
            <p class="m-0" style="color: yellow"><?php echo $searchText ?></p>
        </div>
    ...
    <div class="container">
        ...
        if (empty($courses))
            echo '<div class="section-title position-relative mb-4">
                    <h1 class="display-4">No Courses Were Found!</h1>
                  </div>';
        else
        ...
        <!-- Row to display individual courses -->
        <div class="row">
            <?php
            ...
            if (!empty($courses)) {
                ...
                foreach ($courses as $course): ?>
                    <div class="col-lg-4 col-md-6 pb-4">
                        <!-- Course list item with dynamic URL -->
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2"
                           href="detail.php?id=<?php echo $course["course_id"]; ?>">
                            <!-- Course image with dynamic source -->
                            <img class="img-fluid" src="./img/<?php echo $course["photo_address"]; ?>" alt="">
                            <!-- Course text details -->
                            <div class="courses-text">
                                <!-- Course title centered with white text -->
                                <h4 class="text-center text-white px-3"><?php echo $course["title"]; ?></h4>
                                <!-- Border-top section with flex layout -->
                                <div class="border-top w-100 mt-3">
                                    <!-- Flex layout for user and star ratings -->
                                    <div class="d-flex justify-content-between p-4">
                                        <!-- Number of students with user icon -->
                                        <span class="text-white"><i class="fa fa-user mr-2"></i><?php echo $course["number_of_students"]; ?></span>
                                        <!-- Star rating with conditional display -->
                                        <span class="text-white"><i class="fa fa-star mr-2"></i><?php if ($course["number_of_students"] > 0) echo $course["rating"]; else echo "0.0" ?><small>(<?php if ($course["number_of_students"] > 0) echo $course["number_of_students"]; else echo "♾"; ?>)</small></span>
                                    </div>
                                </div>
                            </div>
                        </a>
    ...
    <div class="container mt-5 pt-5">
        ...
        <div class="row">
            <div class="col-md-6 mb-5">
                ...
                <a href="index.php" class="navbar-brand">
                    <h1 class="mt-n2 text-uppercase text-white"><i class="fa fa-book-reader mr-3"></i>StudyFlow</h1>
                </a>
        ...
        <div class="row">
            <div class="col-md-4 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>123 yashpark surat</p>
                <p><i class="fa fa-phone-alt mr-2"></i>9825524369</p>
                <p><i class="fa fa-envelope mr-2"></i>contact@StudyFlow.com</p>

                <!-- Social links -->
                <div class="d-flex justify-content-start mt-4">
                    <a class="text-white mr-4" href="https://twitter.com/StudyFlows"><i class="fab fa-2x fa-twitter"></i></a>
                    <a class="text-white mr-4" href="https://www.facebook.com/StudyFlows/"><i
                                class="fab fa-2x fa-facebook-f"></i></a>
                    <a class="text-white mr-4" href="https://www.linkedin.com/in/StudyFlows/"><i
                                class="fab fa-2x fa-linkedin-in"></i></a>
                    <a class="text-white" href="https://www.instagram.com/StudyFlows"><i
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                ...
                <!-- Copyright text -->
                <p class="m-0">Copyright &copy; <a class="text-white" href="#">StudyFlow</a>. All Rights Reserved.
                </p>
            </div>
        </div>
    </div>
