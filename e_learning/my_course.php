...
$password = "";
$database = "studyflow";
$category_name = ""; // Unused variable; consider removing or providing a purpose

$thisUserID = "0";

// Check if user is logged in
if (isset($_SESSION["id"])) {
    $thisUserID = $_SESSION["id"]; // Set the current user ID if available in the session
}
...
try {
    ...
    // Prepare and execute SQL query to fetch course information
    $stmt = $conn->prepare("SELECT c.*, COALESCE(e.number_of_students, 0) AS number_of_students
                                    ...
                                    WHERE c.course_id IN (SELECT course_id FROM Enrollments WHERE user_id = :receivedValue);");

    // Bind the parameter for user ID
    $stmt->bindParam(':receivedValue', $_SESSION["id"]);
    ...
    <div class="row py-2 px-lg-5">
        ...
        <div class="col-lg-6 text-center text-lg-right">
            ...
            <div class="d-inline-flex align-items-center">
                ...
                <a class="text-white pl-2" href="https://youtube.com">
    ...
    <div class="container">
        ...
        if ($thisUserID != "0") {
            ...
            if (empty($courses))
                ...
                // Display section title for user's courses
                if (isset($_GET['category']))
                    echo '<div class="section-title position-relative mb-4">
                        <h1 class="display-4">My Courses:</h1>
                      </div><br><br>';
        } else {
            // Display message if the user needs to log in
            echo '<div class="section-title position-relative mb-4">
                        <h1 class="display-4">You need to log in first!</h1>
                      </div>';
        }
        ?>
                        ...
                        <div class="courses-text">
                            ...
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <!-- Display number of students and course rating -->
    ...
    <div class="container mt-5 pt-5">
        ...
        <div class="row">
            <div class="col-md-4 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>123 yash park surat</p>
                ...
                <div class="d-flex justify-content-start mt-4">
                    ...
                    <a class="text-white mr-4" href="https://www.facebook.com"><i
                                class="fab fa-2x fa-facebook-f"></i></a>
                    <a class="text-white mr-4" href="https://www.linkedin.com"><i
