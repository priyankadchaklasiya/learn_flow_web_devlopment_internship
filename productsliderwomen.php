...
function make_slide_indicators1($conn)
{
     $output = ''; 
     $count = 0;
    $subcount = 0;
     $result = make_query1($conn);
     while($row = mysqli_fetch_array($result))
     {
         if($count == 0)
         {
             $output .= '<li data-target="#abcwomen" data-slide-to="'.$count.'" class="active"></li>';
         }
         else if(($count%6 == 0) && $count != 0)
         {
             $subcount = $subcount+1;
             $output .= '<li data-target="#abcwomen" data-slide-to="'.$subcount.'"></li>';
         }
         $count = $count + 1;
     }
     return $output;
...
<div class="product_slider women">
        <div class="container-fluid">          
            <div id="abcwomen" class="carousel slide" data-ride="carousel" >
                <ol class="carousel-indicators">
                    <?php echo make_slide_indicators1($conn); ?>
                </ol>
            ...
            <a class="left carousel-control" href="#abcwomen" role="button" data-slide="prev">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="right carousel-control" href="#abcwomen" role="button" data-slide="next">
